...
const TimeBasedAnalysisCreated = () => {
      ...
      <div className="pt-4">
        ...
        <div className="time_basedtble">
          <div className="fitler-wrapper">
            ...
            <div className="inline-filter-wrapper">
              <a href="#" className="theme-link text-white ml-2">
                <Image src={icnLightPlus} alt="icn-light-export.svg" /> Perform time based analysis
              </a>
            </div>
          </div>
          <Table responsive className="site-table text-nowrap">
            ...
            <tbody>
              <tr>
                <td>Lateral Time-based X-Ray Analysis</td>
                <td>C1</td>
                <td>Neutral</td>
                <td>04/20/2024</td>
                <td>
...
export default TimeBasedAnalysisCreated;
